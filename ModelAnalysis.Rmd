...
ggplot(KnnResultsDataframe, aes(x=reorder(variableFrequencyVectorKnn, -Freq), y = Freq)) + 
...
ggplot(NaiveBayesResultsDataframe, aes(x=reorder(variableFrequencyVectorNaiveBayes, -Freq), y = Freq)) + 
    geom_bar(stat="identity")
```
